...
import AIDialogPanel from '@/components/ai/AIDialogPanel';
import { useInstances } from '@/hooks/useInstances';
import { Server, Clock, CreditCard, Database, Sparkles, Brain } from 'lucide-react';
        ...
        <div className="bg-background p-4 rounded-md shadow-sm space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" asChild className="h-8">
              <Link to="/ai-customization" className="flex items-center gap-1">
          ...
          <Tabs defaultValue="dialog" className="space-y-4">
            <TabsList className="bg-muted/20 p-1">
              <TabsTrigger value="dialog" className="data-[state=active]:bg-primary/10 data-[state=active]:text-primary">
                <Sparkles className="h-3.5 w-3.5 mr-1.5" />AI 对话
              </TabsTrigger>
            </TabsList>
